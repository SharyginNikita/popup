...
var Popup=function(){function Popup(){var _this=this;_classCallCheck(this,Popup);var popup=this._createPopup();var closer=popup.querySelector('.closer');var body=document.body;this._element=popup;this._content=popup.querySelector('.content');this._status='closed';body.appendChild(popup);closer.addEventListener('click',function(event){if(event.target===closer)_this.close();});popup.addEventListener('click',function(event){if(event.target===popup)_this.close();});}
